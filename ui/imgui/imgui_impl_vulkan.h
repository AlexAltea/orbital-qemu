...
IMGUI_IMPL_API void     ImGui_ImplVulkan_Shutdown(void);
IMGUI_IMPL_API void     ImGui_ImplVulkan_NewFrame(void);
IMGUI_IMPL_API void     ImGui_ImplVulkan_SetQueuedFramesCount(uint32_t count);
IMGUI_IMPL_API void     ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer);
IMGUI_IMPL_API bool     ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer);
IMGUI_IMPL_API void     ImGui_ImplVulkan_InvalidateFontUploadObjects(void);

// Called by ImGui_ImplVulkan_Init() might be useful elsewhere.
IMGUI_IMPL_API bool     ImGui_ImplVulkan_CreateDeviceObjects(void);
IMGUI_IMPL_API void     ImGui_ImplVulkan_InvalidateDeviceObjects(void);
...
typedef struct ImGui_ImplVulkanH_FrameData
{
...
IMGUI_IMPL_API ImGui_ImplVulkanH_FrameData ImGui_ImplVulkanH_FrameData_Create(void);

// Helper structure to hold the data needed by one rendering context into one OS window
typedef struct ImGui_ImplVulkanH_WindowData
{
    int                 Width;
    int                 Height;
...
IMGUI_IMPL_API ImGui_ImplVulkanH_WindowData ImGui_ImplVulkanH_WindowData_Create(void);
